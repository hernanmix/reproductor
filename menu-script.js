...
<style>
  ...
  .nav-btn.active svg { color: #3b82f6; }
</style>
...
<nav class="fixed bottom-0 left-0 w-full bg-custom-dark border-t border-gray-800 shadow-2xl z-40 overflow-hidden">
  ...
  <div class="flex justify-around items-center h-16 relative z-10">
    ...
    <a href="/2026/02/tv.html" class="nav-btn flex flex-col items-center justify-center text-gray-400 hover:text-white transition-colors">
      <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <span class="text-[10px] mt-1 font-bold">TV</span>
    </a>

    <a href="https://hsports4hd.blogspot.com/2026/02/donar.html" class="nav-btn flex flex-col items-center justify-center text-gray-400 hover:text-white transition-colors">
      <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <span class="text-[10px] mt-1 font-bold">DONAR</span>
    </a>

    <a href="https://hsports4hd.blogspot.com/2026/02/disney2.html" class="nav-btn flex flex-col items-center justify-center text-gray-400 hover:text-white transition-colors">
      <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path d="M7 4v16M17 4v16M3 8h4m10 0h4M3 12h18M3 16h4m10 0h4M4 20h16a1 1 0 001-1V5a1 1 0 00-1-1H4a1 1 0 00-1 1v14a1 1 0 001 1z" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path>
      </svg>
      <span class="text-[10px] mt-1 font-bold">DISNEY</span>
    </a>

    <button class="nav-btn flex flex-col items-center justify-center text-gray-400 hover:text-white transition-colors" onclick="startAds();">
      <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <span class="text-[10px] mt-1 font-bold">ADS</span>
    </button>
  </div>
</nav>
