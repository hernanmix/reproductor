...
function renderEvents(data) {
  ...
  data.forEach(ev => {
    ...
    // Mostrar la fecha y hora dentro de la hora programada
    card.innerHTML = `
      ...
      <div style="padding:10px">
        ...
        <h3>${ev.title}</h3>
        <p>${ev.league}</p>
        <p><small>${formattedDate} • ${formattedStartTime} a ${formattedEndTime}</small></p> <!-- Mostrar la fecha y hora aquí, dentro de la programación -->
      </div>
    `;
