...
function renderEvents(data) {
  ...
  data.forEach(ev => {
    ...
    // Mostrar la fecha y hora en formato "30 de abril del 2026 • 02:00 p.m. a 04:00 p.m."
    card.innerHTML = `
      ...
      <div style="padding:10px">
        ...
        <h3>${ev.title}</h3>
        <p>${ev.league}</p>
        <p><small>${formattedDate} • ${formattedStartTime} a ${formattedEndTime}</small></p> <!-- Mostrar la fecha y hora aquí -->
      </div>
    `;
